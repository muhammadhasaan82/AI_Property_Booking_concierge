...
import_line = 'from app.services.confirmation_helpers import _render_receipt\n'
...
import_config_line = 'import app.services.config as config\n'
if import_config_line not in text:
    if 'import app.services.config' not in text:
