...
with open(r'c:\Users\ASUS\Desktop\Hotel booking\backend\app\services\agents.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Make sure we have the imports
import_helper = "from app.services.confirmation_helpers import _render_receipt\n"
if "from app.services.confirmation_helpers import _render_receipt" not in content:
    content = import_helper + content
    
if "import app.services.config as config" not in content:
    content = "import app.services.config as config\n" + content
...
with open(r'c:\Users\ASUS\Desktop\Hotel booking\backend\app\services\agents.py', 'w', encoding='utf-8') as f:
    f.write(content)
