...
AGENTS_PATH = r'c:\Users\ASUS\Desktop\Hotel booking\services\agents.py'
NLP_PATH = r'c:\Users\ASUS\Desktop\Hotel booking\services\nlp_extractor.py'
TRACING_PATH = r'c:\Users\ASUS\Desktop\Hotel booking\services\tracing.py'
...
if 'from services.confirmation_helpers import _render_receipt' not in text:
    text = 'from services.confirmation_helpers import _render_receipt\n' + text
if 'import services.config as config' not in text:
    text = 'import services.config as config\n' + text
...
if os.path.exists(NLP_PATH):
    ...
    if 'get_thresholds' not in nlp_text:
        nlp_text = nlp_text.replace('from services.config import', 'from services.dynamic_config import get_thresholds\nfrom services.config import')
        if 'from services.dynamic_config import get_thresholds' not in nlp_text:
            nlp_text = 'from services.dynamic_config import get_thresholds\n' + nlp_text
